...
# 
#${ETH_BIN}/geth --datadir=${ETH_DATA}_${shardID} --rpc --rpcport \"$((8000 + ${c}))\" --syncmode "full" --cache 40960 --gasprice 0 --networkid 10001 --nodiscover --unlock 0 --mine --minerthreads 1 --unlock 0 console 2>>geth.log
